...
class ReportPageState extends ConsumerState<ReportPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ref.watch(transactionProvider).value!.isEmpty
        ...
        : Padding(
            padding:
                const EdgeInsets.only(bottom: UIConst.spacingXL), // Bottom padding for navigation
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: SegmentedButton(
                    segments: const [
                      ButtonSegment(
                          value: TransactionConst.income, label: Text('Income'), icon: Icon(null)),
                      ButtonSegment(
                                                  ...
                                                  PieChartData(
                                                    sections: List.generate(
                                                      ...
                                                      (index) {
                                                        ...
                                                        double value = categoryBalanceMap[category]!
                                                            .toDouble();
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ReportRow(
                                    title: 'Expense',
                                    data:
                                        currencyFormat(reportByMonth.getTotalExpense().toString()),
                                  ),
                                  ReportRow(
                                  ...
                                  ReportRow(
                                    title: 'Summary',
                                    data:
                                        currencyFormat(reportByMonth.getTotalSummary().toString()),
                                    dataStyle: TextStyle(
